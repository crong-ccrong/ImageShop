...
public class ItemController {
	...
	public String register(Item item, RedirectAttributes rttr) throws Exception {
		...
		item.setPictureUrl(createdPreviewFilename);
	...
	public String modify(Item item, RedirectAttributes rttr) throws Exception {
		...
		MultipartFile preivewFile = item.getPreview();

		if (preivewFile != null && preivewFile.getSize() > 0) {
			String createdFilename = uploadFile(preivewFile.getOriginalFilename(), preivewFile.getBytes());
